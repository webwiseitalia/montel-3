    ...
    <div ref={containerRef}>
      ...
      <section className="relative min-h-[70vh] flex items-center bg-slate-950 overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroImage} alt="Azienda Mont.El - Gruppo industriale italiano" title="Mont.El Azienda" loading="lazy" width={2500} height={900} className="w-full h-full object-cover opacity-40" />
